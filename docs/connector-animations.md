...
- Reference: outer `data-anim="reference"`; inner `data-reference-stage`; hub `data-reference-center`; cards `data-reference-card="left-top"`, `"left-bottom"`, `"right-top"`, `"right-bottom"`. Keep these cards on their named sides.
